...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
   <head>
      <meta charset="utf-8">
      <title>AdrianoMarinho.com.br - Freelancer Web | Desenvolvendo Soluções para Necessidades Específicas</title>
      <meta name="description" content="Template para AdrianoMarinho.com.br">
      <meta name="author" content="ADRIANOMARINHO.COM.BR">
      <!-- Mobile Metas -->
               ...
               <div class="slidedown collapse">
                  <div class="container">
                     <div class="phone-email pull-left">
                        <a><i class="fa fa-phone"></i> Fone : +55 (98)8147-9020</a>
                        <a href="adriano@adrianomarinho.com.br"><i class="fa fa-envelope"></i> Email : adriano@adrianomarinho.com.br</a>
                     </div>
                  ...
                  <nav class="collapse navbar-collapse menu">
                     <ul class="nav navbar-nav sf-menu">
                        ...
                        <li>
                           ...
                           <ul>
                              <li><a href="index-2.html" class="sf-with-ul">WEBSITES</a></li>
                              <li><a href="index-3.html" class="sf-with-ul">CRIAÇÃO GRÁFICA</a></li>
                           </ul>
                        </li>
                        <li>
                           <a href="#" class="sf-with-ul">
